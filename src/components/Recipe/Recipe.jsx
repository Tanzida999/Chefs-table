    ...
    return (
        <div className='border p-4 rounded-md shadow-md w-2/3 max-w-lg mx-auto mt-4'>
            <div className='justify-center mb-8'>
                <img className='h-72 w-full object-cover' src={recipe_image} alt={`Cover picture of the recipe ${recipe_name}`} />
            </div>
            ...
            <button 
            onClick={() => handleAddToCooking(recipe)}
            className='btn btn-primary mt-4 justify-start'>Want to cook</button>
        </div>
    );
};
